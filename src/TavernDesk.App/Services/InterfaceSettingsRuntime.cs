...
public static class InterfaceSettingsRuntime
{
    ...
    private static readonly IReadOnlyDictionary<string, string> DarkThemeBrushes =
        new Dictionary<string, string>(StringComparer.Ordinal)
        {
            ["WindowBackgroundBrush"] = "#14161A",
            ["SurfaceBrush"] = "#1B1D22",
            ["SurfaceSolidBrush"] = "#202329",
            ["SurfaceAltBrush"] = "#272A31",
            ["BorderBrush"] = "#363B45",
            ["TextBrush"] = "#F2F4F8",
            ["MutedTextBrush"] = "#9AA3B5",
            ["AccentBrush"] = "#2F8EE5",
            ...
            ["AppicaShellCanvasBrush"] = "#14161A",
            ["AppicaShellSurfaceBrush"] = "#1C1E23",
            ["AppicaShellDividerBrush"] = "#30343C",
            ["AppicaShellTextBrush"] = "#F3F4F6",
            ["AppicaShellMutedBrush"] = "#A8AFBD",
